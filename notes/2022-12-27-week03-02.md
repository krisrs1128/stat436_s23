...
*[Reading](https://rafalab.github.io/dsbook/gapminder.html),
[Recording](https://mediaspace.wisc.edu/media/1_9kea0t1o),
[Rmarkdown](https://raw.githubusercontent.com/krisrs1128/stat479/master/_posts/2021-01-20-week2-4/week2-4.Rmd)*
...
![](2022-12-27-week03-02_files/figure-markdown_strict/unnamed-chunk-3-1.png)

You might wonder, why not plot the raw data? We do this using a
`geom_point` below. The result isn’t as satisfying, because, while the
shape of the ridges popped out immediately in the original plot, we have
to invest a bit more effort to understand the regions of higher density
in the raw data plot. Also, when there are many samples, the entire
range might appeared covered in marks when in fact there are some
intervals with higher density than others.

    ggplot(gapminder_subset, aes(dollars_per_day, group)) +
      geom_point(shape = "|", size = 5) +
      scale_x_log10()

![](2022-12-27-week03-02_files/figure-markdown_strict/unnamed-chunk-4-1.png)
...
![](2022-12-27-week03-02_files/figure-markdown_strict/unnamed-chunk-5-1.png)
...
![](2022-12-27-week03-02_files/figure-markdown_strict/unnamed-chunk-6-1.png)
...
![](2022-12-27-week03-02_files/figure-markdown_strict/unnamed-chunk-7-1.png)

We can adjust the areas of the curves by directly referencing the
`..count` variable, which is implicitly computed by ggplot2 while it’s
computing these densities.
...
![](2022-12-27-week03-02_files/figure-markdown_strict/unnamed-chunk-8-1.png)
...
![](2022-12-27-week03-02_files/figure-markdown_strict/unnamed-chunk-9-1.png)
...
![](2022-12-27-week03-02_files/figure-markdown_strict/unnamed-chunk-10-1.png)
