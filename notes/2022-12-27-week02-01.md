...
[Recording](https://mediaspace.wisc.edu/media/1_g6qrvdjz),
[Rmarkdown](https://raw.githubusercontent.com/krisrs1128/stat479/master/_posts/2021-01-20-week2-1/week2-1.Rmd)*
...
In ggplot2, we can implement this idea using the `facet_wrap` and
...
![](2022-12-27-week02-01_files/figure-markdown_strict/unnamed-chunk-2-1.png)
...
![](2022-12-27-week02-01_files/figure-markdown_strict/unnamed-chunk-3-1.png)
...
![](2022-12-27-week02-01_files/figure-markdown_strict/unnamed-chunk-4-1.png)
...
![](2022-12-27-week02-01_files/figure-markdown_strict/unnamed-chunk-5-1.png)
...
data were the basis for [this
study](https://pubmed.ncbi.nlm.nih.gov/20847294/).
...
variables – this is in the `svalue` column. We’ll discuss ways to do
this during the week on time series visualization.
...
![](2022-12-27-week02-01_files/figure-markdown_strict/unnamed-chunk-7-1.png)
It seems like some of the species are much more abundant than others. In
this situation, it *might* make sense to rescale the *y*-axis. Though,
this is always a risky decision – people might easily misinterpret the
plot and conclude that the different species all have the same
abundances. Nonetheless, it can’t hurt to try, using the `scale`
...
![](2022-12-27-week02-01_files/figure-markdown_strict/unnamed-chunk-8-1.png)
...
![](2022-12-27-week02-01_files/figure-markdown_strict/unnamed-chunk-9-1.png)
