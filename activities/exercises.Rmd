...
series questions visually.
    ...
    c. Create either a line or heatmap visualization of the time series across
    all countries. Create a new version that zooms into a subset of countries of
    interest. Why did you choose those countries, and what did you learn?
...
1. [Why vector data?] In your own words, explain the key characteristics of
vector datasets. Why can't vector data simply be stored as csv files?
...
1. [Glacial Lakes]. The data at this [link](https://raw.githubusercontent.com/krisrs1128/stat436_s23/main/data/GL_3basins_2015.topojson) contain labels of glacial lakes the
...
International Centre for Integrated Mountain Development.
    ...
    d. Part (c) allowed us to visualize the lake data within a vary small region.
...
raster masking.
    ...
    a. Read in the raster data and visualize the variation temperature over
    space.
...
1. [Geospatial Portfolio] The links below are from past portfolio projects. Pick
_two_ of these links and answer the following prompts.

    * [Wisconsin Library Budgets](https://krisrs1128.github.io/portfolio_site_s22/education/2022/05/22/ough.html)
    * [Analysis of Terrorist Attacks](https://krisrs1128.github.io/portfolio_site_s22/society/2022/05/22/yangjina.html)
    * [Augsburg Landcover Classification](https://krisrs1128.github.io/portfolio_site_s22/remote%20sensing/2022/05/22/lyu.html)
    * [Mass Shooting in the US (2018-2021)](https://krisrs1128.github.io/portfolio_site_s22/society/2022/05/22/mishra.html)
    * [Traffic Accidents in United States](https://krisrs1128.github.io/portfolio_site_s22/society/2022/05/22/mi.html)
    * [California Housing Costs](https://krisrs1128.github.io/portfolio_site_s22/economics/2022/05/22/kim.html)
    * [Finland Population Change](https://krisrs1128.github.io/portfolio_site_s22/demography/2022/05/22/fu.html)
    * [World Happiness](https://krisrs1128.github.io/portfolio_site_s22/society/2022/05/22/bhutada.html)
    * [Michelin Awarded Restaurants](https://krisrs1128.github.io/portfolio_site_s22/food%20and%20drink/2022/05/22/tu.html)
  
    a. Summarize the goals and data sources behind the visualization. Are the
    underlying data vector or raster spatial format?
    
    b. What interactive queries did the students implement? Discuss the visual
    design and offer at least one alternative design approach that supports the same
    queries.
